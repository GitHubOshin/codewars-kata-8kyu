 ...
 *   parameters username and password. This is a generic login function which will check
 *   the database for the user it will return either 'Successfully Logged in!' if it passes
 *   the test or 'Wrong username or password!' if either the password is wrong
